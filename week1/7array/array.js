...
numbers.unshift(9,11,18,8)  //adds one or more element to the beginning of the array
// print()
...
// it is a powerful array method for adding, removing and replacing the elements of the array
            ...
            //  print()
            numbers.splice(3, 3, 77, 88 , 99) // starts at index 3 removes 0 elements and adds 77,88 and 99 at indices 3, 4, 5 respectively
                print()
            numbers.splice(1,1 , 5) //starts at index 1 removes one element and adds Haile at that index in another word it replace the item at idex of one
                print()
